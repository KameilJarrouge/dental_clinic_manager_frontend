...
function Tooth1({}) {
  return (
    // <div className={`${className} relative group top-[0] left-[0px]`}>
      ...
      >
        <defs className="ClipPathGroup">
          <clipPath id="presentation_clip_path" clipPathUnits="userSpaceOnUse">
            <rect x="0" y="0" width="991" height="940" />
          </clipPath>
          <clipPath
            id="presentation_clip_path_shrink"
            clipPathUnits="userSpaceOnUse"
          >
            <rect x="0" y="0" width="990" height="939" />
          </clipPath>
        </defs>
                    ...
                    <g className="com.sun.star.drawing.ClosedBezierShape">
                      <g id="id4">
                        ...
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeLinecap="round"
                          d="M 277,903 C 7,832 31,104 31,104 115,-71 1022,74 957,279 844,635 580,983 277,903 Z"
                        />
                      </g>
                    </g>
                    <g className="com.sun.star.drawing.ClosedBezierShape">
                    ...
                    <g className="com.sun.star.drawing.OpenBezierShape">
                      <g id="id6">
                        ...
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeLinecap="round"
                          d="M 241,250 C 398,184 562,207 737,346"
                        />
                      </g>
                    </g>
                  </g>
    ...
    //   {badges.length !== 0 && (
    //     <div
    //       className={`absolute ${rotation} top-[12mm] left-[1mm]   w-[18px]  flex gap-1 flex-wrap  items-center invisible  group-hover:visible  `}
    //     >
    //       {children}
    //     </div>
    //   )}
