...
function Tooth5({
  ...
  return (
    // <div className={`${className} relative group top-[29.7mm] left-[22.5mm]`}>
    ...
    >
      <defs className="ClipPathGroup">
        <clipPath id="presentation_clip_path" clipPathUnits="userSpaceOnUse">
          <rect x="0" y="0" width="1118" height="1219" />
        </clipPath>
        <clipPath
          id="presentation_clip_path_shrink"
          clipPathUnits="userSpaceOnUse"
        >
          <rect x="1" y="1" width="1116" height="1217" />
        </clipPath>
      </defs>
                  ...
                  <g className="com.sun.star.drawing.ClosedBezierShape">
                    <g id="id4">
                      ...
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeLinecap="round"
                        d="M 228,1149 C 389,1240 715,1179 904,1169 904,1169 1057,1115 1079,831 1086,742 964,637 978,533 1007,327 864,77 721,40 352,-57 170,221 72,459 -17,677 79,977 228,1149 Z"
                      />
                    </g>
                  </g>
                  <g className="com.sun.star.drawing.ClosedBezierShape">
                  ...
                  <g className="com.sun.star.drawing.ClosedBezierShape">
                    <g id="id6">
                      ...
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeLinecap="round"
                        d="M 557,198 C 591,300 614,400 607,489 558,517 474,449 410,421 L 582,591 C 635,717 591,807 582,916 631,912 666,971 699,1038 698,973 648,867 711,855 L 847,943 717,787 C 717,787 693,685 724,706 754,726 914,713 914,713 914,713 754,699 705,611 656,523 662,475 662,421 662,367 678,316 656,272 637,234 557,198 557,198 Z"
                      />
                    </g>
                  </g>
                  <g className="com.sun.star.drawing.OpenBezierShape">
                    <g id="id7">
                      ...
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeLinecap="round"
                        d="M 284,429 C 229,697 270,869 387,1042"
                      />
                    </g>
                  </g>
                </g>
