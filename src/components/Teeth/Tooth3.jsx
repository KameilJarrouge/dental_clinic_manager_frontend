...
function Tooth3({
  ...
  return (
    // <div className={`${className} relative group top-[9.1mm] left-[14.5mm]`}>
    ...
    >
      <defs className="ClipPathGroup">
        <clipPath id="presentation_clip_path" clipPathUnits="userSpaceOnUse">
          <rect x="0" y="0" width="914" height="864" />
        </clipPath>
        <clipPath
          id="presentation_clip_path_shrink"
          clipPathUnits="userSpaceOnUse"
        >
          <rect x="0" y="0" width="913" height="863" />
        </clipPath>
      </defs>
                  ...
                  <g className="com.sun.star.drawing.ClosedBezierShape">
                    <g id="id4">
                      ...
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeLinecap="round"
                        d="M 61,689 C -9,466 53,204 221,75 324,-5 496,15 612,75 743,141 830,290 871,431 908,559 843,860 710,840 430,798 139,942 61,689 Z"
                      />
                    </g>
                  </g>
                  <g className="com.sun.star.drawing.ClosedBezierShape">
                  ...
                  <g className="com.sun.star.drawing.OpenBezierShape">
                    <g id="id6">
                      ...
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeLinecap="round"
                        d="M 397,173 C 669,221 719,438 733,594"
                      />
                    </g>
                  </g>
                </g>
    ...
    //   {/* {badges.length !== 0 && (
    //     <div
    //       className={`absolute ${rotation} top-[7mm] -left-[4.5mm]   w-[18px]   flex gap-1 flex-wrap  items-center invisible  group-hover:visible  `}
    //     >
    //       {children}
    //     </div>
    //   )} */}
